"""
Django settings for remindme_log project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-rtov0$+fq$_v)#58&dz%v!-7i5jduaua*l9_c_&gy_ql+&$zg^')
...
ROOT_URLCONF = 'remindme_log.urls'
...
WSGI_APPLICATION = 'remindme_log.wsgi.application'
